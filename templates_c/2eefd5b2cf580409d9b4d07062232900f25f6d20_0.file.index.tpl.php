...
">
                    <div class="card-body">
                        ...
                        <p class="card-text"><?php if ($_smarty_tpl->tpl_vars['compteurmots']->value < 300) {
echo $_smarty_tpl->tpl_vars['value']->value['texte'];
} else {
echo substr($_smarty_tpl->tpl_vars['value']->value['texte'],0,400);
}?></p><!--Limiter nb de mots-->
                        <a href="affart.php?id=<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
&action=consultation" class="btn btn-primary">Afficher article</a>
